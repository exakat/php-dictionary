...
In web applications, an ``ACL`` is typically implemented as a matrix of subjects, like users, roles..., and objects, like routes, resources, actions..., where each cell defines the permissions granted. ``ACL`` provide fine-grained authorization control, complementing authentication.
