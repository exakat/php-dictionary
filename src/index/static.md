...
<?php
    ...
    class Elephpant {
        ...
        function habitat() {
            ...
            // same as \Elephpant::HABITAT; when the object is of class Elephpant
            // same as \AsianElephpant::HABITAT; when the object is of class AsianElephpant
        }
    }

    class AsianElephpant extends Elephpant {
        private const HABITAT = 2;
    }
