...
class Elephpant {
    ...
    public function trumpet() {  echo $this->age;  }
}

$fn = Closure::fromCallable([new Elephpant(10), 'trumpet']);
$fn();

$fn2 = $fn->bindTo(new Elephpant(99), Elephpant::class);
$fn2();

// $fn is called with another object
$fn->call(new Elephpant (100));
