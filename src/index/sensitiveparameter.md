...
<?php
    ...
    function trumpet(
        ...
        throw new Exception('Could not trumpet');
    }
    ...
    Fatal error: Uncaught Exception: Could not trumpet in file.php:6
    Stack trace:
    #0 file.php(9): trumpet(Object(SensitiveParameterValue))
    #1 {main}
