...
<?php
    ...
    $elephpant->trumpet(); // Elephpant::trumpet
    $elephpant->stampede(); // Elephpant::stampede

    // existence check
    var_dump(method_exists(Elephpant::class, 'trumpet'));    // true
    var_dump(method_exists(Elephpant::class, 'stampede'));    // false
    var_dump(method_exists(Elephpant::class, '__call')); // true
