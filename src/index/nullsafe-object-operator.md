...
<?php
    ...
    class Elephpant {
        public $trunkLength = 1;
    }
    
    // This will not fail, but also display nothing
    echo trumpet()?->trunkLength;
    
    // This will fail, when trumpet() returns null
    echo trumpet()->trunkLength;
