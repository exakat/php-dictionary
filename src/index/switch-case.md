...
<?php
    ...
    switch($trunk) {
        ...
        // default case, when $trunk is not 'a' 'b' or 'c'
        default :
            $a = 3;
    }
...
+ [Switch statement (fallthrough) - Wikipedia](https://en.wikipedia.org/wiki/Switch_statement#Fallthrough)
