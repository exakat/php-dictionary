...
<?php
    ...
    class Elephpant {
        // public constant
        const HABITAT = 1;
        public $trunkLength = 2;
    }

    $elephpant = new Elephpant;
    echo $elephpant->trunkLength;
    echo Elephpant::HABITAT;
