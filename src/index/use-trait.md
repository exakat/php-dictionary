...
<?php
    ...
    trait Tusk {
        use Trunk {
            Trunk::trumpet as goo; // aliasing
            Trunk::trumpet insteadof trumpet; // aliasing
            Tusk::trumpet as hoo; // aliasing
        }
