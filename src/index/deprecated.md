...
trumpet();
//Deprecated: Function trumpet() is deprecated

#[Deprecated('Use forage instead.')]
function trample() {}

trample();
//Deprecated: Function trample() is deprecated, Use forage instead.
