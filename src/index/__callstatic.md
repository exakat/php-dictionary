    ...
    class Elephpant {
        ...
        static function __callStatic($name, $args) {
            if (method_exists(self::class, $name)) {
                return Elephpant::$name(...$args);
            }

            return 0;
        }

        private static function trumpet() {
            print __METHOD__;
        }
    }

    Elephpant::trumpet(); // Elephpant::trumpet
    Elephpant::forage(); // nothing
