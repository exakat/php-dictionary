...
<?php
    ...
    $trunk = new Box();
    $tusk = $trunk;      // reference copy: both variables share the same object
    $tusk->n = 2;
    echo $trunk->n;   // 2, objects are never value types in PHP
