# zip Extension
The zip extension provides functions to handle the zip compression format. It reads, writes and accesses arbitrary part of files. It also provides a compression format for the output of PHP.
