...
$callable1 = [new Elephpant, 'trumpet'];
$callable1(); // Elephpant::trumpet

$callable2 = ['Elephpant', 'stampede'];
$callable2(); // Elephpant::stampede

$callable3 = [Elephpant::class, 'stampede'];
$callable3(); // Elephpant::stampede
