...
class Elephpant {
    public function trumpet($trunk, $tusk) {
        // $tusk is ignored, and set to a fixed value.
        // $tusk is actually removed for 'public' usage
        $this->forage($trunk, 2);
    }

    private function forage($trunk, $tusk = 1) {
        // do Something
    }
}
?>
