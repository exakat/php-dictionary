...
class Elephpant {
    ...
    public int $trunkLength = 3;
    public int $earSize = 4;
    public int $herdSize;

    static string $species = 'abc';
...
print_r(get_object_vars(new elephpant));
