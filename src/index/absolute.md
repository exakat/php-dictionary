...
namespace Savanna{
    // second definition
    function trumpet() {
        echo 'in the savanna scope.';
    }

    trumpet(); // relative call: it goes to the second definition
    \trumpet(); // absolute call: it goes to the first definition
    \Savanna\trumpet(); // absolute call: it goes to the second definition
}
