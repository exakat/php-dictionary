...
<?php
    ...
    function forage() {
        // this variable is distinct from the one in trumpet()
        $localVariable = 2;
        // ... more code
    }
