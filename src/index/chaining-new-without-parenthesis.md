...
class Elephpant {
    ...
    public function trumpet() { echo __METHOD__; }

    public function __invoke() { echo __METHOD__; }
}

new elephpant()->property;  // 1
new elephpant()->trumpet();     // Elephpant::trumpet
new elephpant()();          // Elephpant::__invoke
