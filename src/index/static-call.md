...
<?php
    ...
    new Elephpant(); // static call

    $class = Elephpant::class;
    new $class(); // dynamic call

    Elephpant::trumpet(); // static call of a static method
    $class::trumpet(); // dynamic call of a static method
