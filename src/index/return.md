...
<?php
    ...
    interface Elephpant {
        function forage(AfricanElephpant $trunk): Elephpant;
    }

    interface AfricanElephpant extends Elephpant {
      function forage(Elephpant $trunk): AfricanElephpant;
    }
