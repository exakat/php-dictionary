# Late Static Binding
PHP implements a feature called late static bindings, or simply late binding, which can be used to reference the called class in a context of static inheritance.
