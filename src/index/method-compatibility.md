...
class Calf extends Elephpant {
    ...
    function forage(int|string $a): Calf {}

    // This is not compatible with the parent's method signature
    function migrate(int $a): int {}
}
