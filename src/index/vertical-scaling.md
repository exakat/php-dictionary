# Vertical Scaling
Vertical scaling, also called scaling up, means increasing the resources to handler larger loads. Resources may be any of processor cores, RAM, disk I/O, or network bandwidth, of an existing machine or container to handle a greater workload, rather than adding more instances.
