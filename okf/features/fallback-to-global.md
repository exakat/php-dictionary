...
description: "The fallback to global mechanism is a PHP feature, which search for functions and global constants, first in the current namespace, then in the global namespace, before failing."
resource: "https://www.php.net/manual/en/language.namespaces.fallback.php"
tags: ["compatibility", "fully-qualified-name", "use"]
generated:
