...
type: "concept"
title: "Random Access"
description: "Random access is the ability to read or write any element of a data structure, or any byte of a file, directly, in constant time, without having to traverse the elements that precede it."
resource: "https://en.wikipedia.org/wiki/Random_access"
tags: ["concept", "data structure", "performance"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Random_access](https://en.wikipedia.org/wiki/Random_access)
