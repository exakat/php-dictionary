...
description: "Poisoned Pipeline Execution, or PPE, is a CI/CD security attack in which an attacker injects malicious code into a repository's CI/CD pipeline configuration or triggered workflow, causing the pipeline to execute attacker-controlled code in a trusted environment."
resource: "https://www.cidersecurity.io/blog/research/ppe-poisoned-pipeline-execution/"
tags: ["security", "vulnerability", "concept", "acronym"]
generated:
