...
type: "PHP Feature"
title: "$_FILES"
description: "The ``$_FILES`` variable is a special superglobal variable that is used to retrieve information about files uploaded to the server via HTML forms with the ``enctype=\"multipart/form-data\"`` attribute."
