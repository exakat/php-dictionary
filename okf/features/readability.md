...
type: "PHP Feature"
title: "Readability"
description: "A code is readable, or easy to read, if all the needed information is available in the code, without the need to reach for an extra piece of reference to understand it."
resource: "https://en.wikipedia.org/wiki/Readability"
tags: ["maintenance", "human"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Readability](https://en.wikipedia.org/wiki/Readability)
