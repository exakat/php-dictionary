...
description: "``Base64`` is a binary-to-text encoding scheme that represents binary data in an ASCII string format."
resource: "https://www.php.net/manual/en/function.base64-encode.php"
tags: ["format"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/function.base64-encode.php](https://www.php.net/manual/en/function.base64-encode.php)
...
## Related
- [UUencode Encoding](/features/uuencode.md)
