...
description: "Function-as-a-Service, or FaaS, is a serverless execution model where individual functions are deployed, invoked on demand, and billed per execution."
resource: "https://en.wikipedia.org/wiki/Function_as_a_service"
...
## Details
- Packagist: [bref/bref](https://packagist.org/packages/bref/bref)
