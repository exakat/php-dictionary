---
type: "exception"
title: "ClosedGeneratorException"
description: "A ``ClosedGeneratorException`` is an exception that occurs when the code tries to perform an operation on a generator that has already been closed."
resource: "https://www.php.net/manual/en/class.closedgeneratorexception.php"
tags: ["exception"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/class.closedgeneratorexception.php](https://www.php.net/manual/en/class.closedgeneratorexception.php)
