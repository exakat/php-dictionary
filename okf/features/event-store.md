...
type: "concept"
title: "Event Store"
description: "An event store is an append-only database that stores domain events as the primary source of truth."
resource: "https://en.wikipedia.org/wiki/Event_store"
tags: ["concept"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Event_store](https://en.wikipedia.org/wiki/Event_store)
...
## Details
- Packagist: [prooph/event-store](https://packagist.org/packages/prooph/event-store)
