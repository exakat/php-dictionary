...
type: "type"
title: "Type Checking"
description: "Type checking is the process of verifying that the types of expressions, variables, arguments, and return values are consistent with their declarations and usage."
resource: "https://en.wikipedia.org/wiki/Type_system#Type_checking"
tags: ["type", "concept", "quality", "rfc", "static analysis"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Type_system#Type_checking](https://en.wikipedia.org/wiki/Type_system#Type_checking)
...
- [Nominal Type](/features/nominal-type.md)
...
- [Gradual Typing](/features/gradual-typing.md)
