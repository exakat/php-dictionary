---
type: "PHP Feature"
title: "Method Compatibility"
description: "Method compatibility means that when a class overrides a method, from a parent class or interface, the new method must keep a compatible signature."
resource: "https://www.php.net/manual/en/language.oop5.basic.php#language.oop.lsp"
tags: ["compatibility", "oop"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/language.oop5.basic.php#language.oop.lsp](https://www.php.net/manual/en/language.oop5.basic.php#language.oop.lsp)
