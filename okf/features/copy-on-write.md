...
description: "``Copy on write``, or COW, is a data management technique where data is shared between contexts, until it is actually modified."
resource: "https://en.wikipedia.org/wiki/Copy-on-write"
tags: ["engine", "acronym", "animal"]
generated:
