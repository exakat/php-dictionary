...
type: "PHP Feature"
title: "php://filter"
description: "``php://filter`` is a meta-wrapper that allows applying one or more filter chains to a stream before the data is read or written."
resource: "https://www.php.net/manual/en/wrappers.php.php"
tags: ["wrapper", "security", "vulnerability"]
generated:
