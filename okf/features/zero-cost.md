...
type: "PHP Feature"
title: "Zero Cost"
description: "``zero cost`` most commonly refers to zero-cost assertions, a feature introduced in version 7.0."
resource: "https://www.php.net/manual/en/function.assert.php"
tags: ["optimisation", "production"]
generated:
...
## Details
- Packagist: [olvlvl/composer-attribute-collector](https://packagist.org/packages/olvlvl/composer-attribute-collector)
