...
type: "concept"
title: "Range Type"
description: "A first-class range type represents an interval of values, such as ``1..10`` in Rust or Kotlin, or ``1...10`` in Swift, as a value in its own right, with its own type."
resource: "https://en.wikipedia.org/wiki/Interval_(mathematics)"
