...
type: "concept"
title: "Type System"
description: "A type system is a formal set of rules that assigns a type to every expression in a program and uses those types to determine which operations are valid, how values are stored, and what errors can be detected before or during execution."
resource: "https://en.wikipedia.org/wiki/Type_system"
tags: ["concept", "language", "type"]
generated:
