...
type: "concept"
title: "Active Record"
description: "Active Record is a design pattern commonly used in development."
resource: "https://en.wikipedia.org/wiki/Active_record_pattern"
tags: ["concept", "dbal"]
generated:
...
- [Create, Read, Update And Delete (CRUD)](/features/crud.md)
- [Structured Query Language (SQL)](/features/sql.md)

## Details
- Packagist: [yiisoft/yii2-redis](https://packagist.org/packages/yiisoft/yii2-redis)
