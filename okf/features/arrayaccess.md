...
type: "PHP Feature"
title: "ArrayAccess"
description: "``ArrayAccess`` is an interface that allows objects to be accessed like arrays using square brackets, similar to accessing elements in a regular array."
resource: "https://www.php.net/manual/en/class.arrayaccess.php"
tags: ["interface"]
generated:
