...
type: "PHP Feature"
title: "http://"
description: "The ``http://`` wrapper is a native PHP wrapper, to access files on a remote ``HTTP`` web server."
resource: "https://www.php.net/manual/en/wrappers.http.php"
tags: ["wrapper", "url"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/wrappers.http.php](https://www.php.net/manual/en/wrappers.http.php)
