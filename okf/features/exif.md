...
description: "EXIF is a standard for storing metadata in image files, particularly JPEG and TIFF."
resource: "https://www.php.net/manual/en/book.exif.php"
tags: ["extension", "metadata", "image", "acronym"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/book.exif.php](https://www.php.net/manual/en/book.exif.php)
