...
description: "Error reporting is the process to report any issue while executing the code."
resource: "https://www.php.net/manual/en/function.error-reporting.php"
tags: ["directive", "native function", "error"]
generated:
...
## Details
- Packagist: [filp/whoops](https://packagist.org/packages/filp/whoops)
