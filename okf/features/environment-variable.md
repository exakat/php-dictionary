...
description: "Environment variables are a way to store and access configuration information or settings related to the runtime environment in which a PHP script is executed."
resource: "https://en.wikipedia.org/wiki/Environment_variable"
tags: ["os", "variable"]
generated:
