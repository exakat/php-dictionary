...
type: "extension"
title: "XMLwriter"
description: "The ``XMLWriter`` PHP extension is a built-in extension that provides a simple and efficient way to generate XML documents."
...
- Packagist: [fluentdom/fluentdom](https://packagist.org/packages/fluentdom/fluentdom)
