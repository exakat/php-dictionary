...
description: "Compile-time evaluation is the ability of a compiler to execute expressions or functions during compilation, embedding the computed result directly in the compiled output rather than deferring it to runtime."
resource: "https://en.wikipedia.org/wiki/Compile-time_function_execution"
tags: ["unsupported", "optimization"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Compile-time_function_execution](https://en.wikipedia.org/wiki/Compile-time_function_execution)
