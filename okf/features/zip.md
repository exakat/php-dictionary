...
type: "extension"
title: "zip Extension"
description: "The zip extension provides functions to handle the zip compression format: read, write and access arbitrary part of files."
resource: "https://www.php.net/manual/en/book.zip.php"
...
## Documentation
- [https://www.php.net/manual/en/book.zip.php](https://www.php.net/manual/en/book.zip.php)
