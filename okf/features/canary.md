...
type: "concept"
title: "Canary"
description: "Canary, borrowed from the miner's canary once used to detect dangerous gas underground, has two distinct meanings in software engineering: + A canary release, or canary deployment, is a rollout strategy where a new version is deployed to a small subset of servers or users first."
resource: "https://martinfowler.com/bliki/CanaryRelease.html"
tags: ["concept", "devops", "sdlc", "disambiguation"]
generated:
