...
type: "concept"
title: "Batch"
description: "Batch processing refers to the treatment of several items at the same time, instead of one at a time."
resource: "https://en.wikipedia.org/wiki/Batch_processing"
tags: ["concept", "data"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Batch_processing](https://en.wikipedia.org/wiki/Batch_processing)
...
## Details
- Packagist: [yokai-php/batch](https://packagist.org/packages/yokai-php/batch)
