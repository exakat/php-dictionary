...
type: "extension"
title: "Tokenizer"
description: "The PHP Tokenizer is a built-in extension that breaks down PHP source code into its fundamental components called tokens."
...
- [Code Formatter](/features/code-formatter.md)
