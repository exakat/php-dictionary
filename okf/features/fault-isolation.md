...
description: "Fault isolation is the design property that limits the impact of a failure to the component or service where it originates, preventing it from cascading to other parts of the system."
resource: "https://en.wikipedia.org/wiki/Fault_isolation"
tags: ["concept"]
generated:
...
## Documentation
- [https://en.wikipedia.org/wiki/Fault_isolation](https://en.wikipedia.org/wiki/Fault_isolation)
