...
type: "control flow"
title: "Goto"
description: "The ``goto`` operator is a language construct that allows to perform an unconditional jump in the flow of your code to a specified label."
resource: "https://www.php.net/manual/en/control-structures.goto.php"
tags: ["control flow", "keyword", "bad practice"]
generated:
...
## Details
- PHP since: 5.3
- Packagist: [symfony/symfony](https://packagist.org/packages/symfony/symfony)
- Packagist: [yiisoft/yii2](https://packagist.org/packages/yiisoft/yii2)
