...
type: "concept"
title: "Ownership"
description: "Ownership, and Borrow Checking, is a compile-time memory model, central to Rust, in which every value has exactly one owning variable at a time."
resource: "view-source:https://en.wikipedia.org/wiki/Rust_(programming_language)#Ownership_and_references"
...
## Documentation
- [view-source:https://en.wikipedia.org/wiki/Rust_(programming_language)#Ownership_and_references](view-source:https://en.wikipedia.org/wiki/Rust_(programming_language)#Ownership_and_references)

## See Also
- [Ownership in Rust](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html)

## Related
- [Move Semantics](/features/move-semantics.md)
