...
type: "PHP Feature"
title: "SVMException"
description: "The SVMException exception is thrown by the ``SVM::train()`` method."
resource: "https://www.php.net/manual/en/book.svm.php"
...
## Documentation
- [https://www.php.net/manual/en/book.svm.php](https://www.php.net/manual/en/book.svm.php)
...
- [Support Vector Machine (SVM)](/features/svm.md)
