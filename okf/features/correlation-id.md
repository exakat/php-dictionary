...
description: "A correlation ID is a unique identifier attached to a request or event so that all related operations across multiple services or log entries can be linked together."
resource: "https://en.wikipedia.org/wiki/Tracing_(software)"
tags: ["concept", "string"]
generated:
