...
type: "PHP Feature"
title: "Type Error"
description: "A ``TypeError`` is an error that occurs when there is a mismatch between the expected data type and the actual data type of a variable or value in your code."
resource: "https://www.php.net/manual/en/class.typeerror.php"
tags: ["error"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/class.typeerror.php](https://www.php.net/manual/en/class.typeerror.php)
