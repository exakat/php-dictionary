...
type: "PHP Feature"
title: "TCP"
description: "``TCP``, which stands for Transmission Control Protocol, is one of the main protocols in the Internet Protocol ``IP`` suite."
...
## Details
- Packagist: [https://packagist.org/packages/react/socket](https://packagist.org/packages/https://packagist.org/packages/react/socket)
