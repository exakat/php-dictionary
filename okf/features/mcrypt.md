...
description: "``mcrypt`` is a PHP extension that provides access to the mcrypt library."
resource: "https://www.php.net/manual/en/ref.mcrypt.php"
tags: ["cryptography"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/ref.mcrypt.php](https://www.php.net/manual/en/ref.mcrypt.php)
