...
description: "The ``RecursiveTreeIterator`` allows iterating over a ``RecursiveIterator`` to generate an ASCII graphic tree."
resource: "https://www.php.net/manual/en/class.recursivetreeiterator.php"
tags: ["iterator", "spl"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/class.recursivetreeiterator.php](https://www.php.net/manual/en/class.recursivetreeiterator.php)
