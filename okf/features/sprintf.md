...
type: "PHP Feature"
title: "sprintf"
description: "``sprintf()`` is a PHP native function, which format a string based on a format string, and one or more values."
resource: "https://www.php.net/manual/fr/function.sprintf.php"
tags: ["native function", "universal function", "arbitrary number of argument"]
generated:
...
## Documentation
- [https://www.php.net/manual/fr/function.sprintf.php](https://www.php.net/manual/fr/function.sprintf.php)
