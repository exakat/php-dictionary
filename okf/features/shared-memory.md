...
type: "PHP Feature"
title: "Shared Memory"
description: "Shared memory is a technique that allows multiple processes to access the same region of memory, enabling fast inter-process communication, ``IPC``, without the overhead of serialization or network transfers."
resource: "https://www.php.net/manual/en/shmop.examples-basic.php"
tags: ["architecture", "concurency"]
generated:
...
## Documentation
- [https://www.php.net/manual/en/shmop.examples-basic.php](https://www.php.net/manual/en/shmop.examples-basic.php)
...
- [Shared Memory Operations (SHMOP)](/features/shmop.md)
