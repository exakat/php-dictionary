...
description: "Named parameters, also known as named arguments allow to pass arguments to a function or method by specifying the parameter name along with the corresponding value, rather than relying on the order of the parameters."
resource: "https://www.php.net/manual/en/functions.arguments.php"
tags: ["feature", "parameter"]
generated:
...
## Related
- [Positional Parameters](/features/positional-parameter.md)
