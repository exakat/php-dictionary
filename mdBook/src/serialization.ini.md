...
Related : [__serialize() Method](__serialize() Method), [__unserialize() Method](__unserialize() Method), [JsonSerializable](JsonSerializable), [Remote Procedure Call (RPC)](Remote Procedure Call (RPC)), [Message Queue](Message Queue), [Cache](Cache), [Object Injection](Object Injection), [Object Injection](Object Injection), [Deep Clone](Deep Clone), [Serde](Serde), [Serializable](Serializable), [var_export()](var_export()), [Insecure Deserialization](Insecure Deserialization), [serialize_precision](serialize_precision), [Snapshot](Snapshot)
