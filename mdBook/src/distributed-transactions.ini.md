...
Related : [ACID](ACID), [Eventual Consistency](Eventual Consistency), [Compensation Logic](Compensation Logic), [Event Sourcing](Event Sourcing), [Microservice](Microservice), [Distributed Systems](Distributed Systems)
