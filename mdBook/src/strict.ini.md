...
Related : [strict_types](strict_types), [Strict Comparison](Strict Comparison), [Type Checking](Type Checking), [Relaxed Comparison](Relaxed Comparison), [Type Juggling](Type Juggling), [in_array()](in_array()), [Match](Match), [Gradual Type Checking](Gradual Type Checking)
