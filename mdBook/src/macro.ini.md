...
Related : [Hygienic Macro](Hygienic Macro), [Metaprogramming](Metaprogramming), [Homoiconicity](Homoiconicity), [Eval()](Eval()), [Token](Token), [Code Generation](Code Generation), [Const](Const)
