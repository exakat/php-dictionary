...
Related : [Rich Domain Model](Rich Domain Model), [Domain Design Driven (DDD)](Domain Design Driven (DDD)), [Domain](Domain), [OOP (Object Oriented Programming)](OOP (Object Oriented Programming)), [Layered Architecture](Layered Architecture)
