...
Related : [Foreign Key](Foreign Key), [Database](Database), [Migration](Migration), [ETL](ETL), [Cascading Failure](Cascading Failure), [Transaction](Transaction), [Validation](Validation), [Silent Behavior](Silent Behavior)
