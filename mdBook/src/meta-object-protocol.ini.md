...
Related : [Reflection](Reflection), [Magic Methods](Magic Methods), [Metaprogramming](Metaprogramming), [Homoiconicity](Homoiconicity), [Proxy](Proxy), [Closure](Closure), [__get() Method](__get() Method), [__call() Method](__call() Method), [Metaclass](Metaclass)
