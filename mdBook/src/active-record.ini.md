...
Related : [Data Mapper](Data Mapper), [Create, Read, Update And Delete (CRUD)](Create, Read, Update And Delete (CRUD)), [Structured Query Language (SQL)](Structured Query Language (SQL))
