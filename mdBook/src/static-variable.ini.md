...
Related : [Variables](Variables), [Variable Variables](Variable Variables), [Global Variables](Global Variables), [global Scope](global Scope), [$GLOBALS]($GLOBALS), [Local Variable](Local Variable), [Superglobal Variables](Superglobal Variables), [Static Property](Static Property), [New In Initializers](New In Initializers)
