...
Related : [Distributed Monolith](Distributed Monolith), [Microservice](Microservice), [Database](Database), [Coupling](Coupling), [Domain Design Driven (DDD)](Domain Design Driven (DDD)), [Event Driven](Event Driven)
