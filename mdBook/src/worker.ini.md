...
Related : [Jobqueue](Jobqueue), [Queue](Queue), [Message Queue](Message Queue), [Process](Process), [Thread](Thread), [Gearman](Gearman), [Swoole](Swoole), [Retry](Retry), [Idempotent](Idempotent)
