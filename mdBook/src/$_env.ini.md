...
Related : [$_GET]($_GET), [$_COOKIE]($_COOKIE), [$_POST]($_POST), [$_REQUEST]($_REQUEST), [$_FILES]($_FILES), [$_SERVER]($_SERVER), [$GLOBALS]($GLOBALS), [Superglobal Variables](Superglobal Variables)
