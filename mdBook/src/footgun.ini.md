...
Related : [Eval()](Eval()), [extract()](extract()), [Error Suppression](Error Suppression), [Variable Variables](Variable Variables), [Type Juggling](Type Juggling), [References](References), [Code Injection](Code Injection), [Anti-Pattern](Anti-Pattern), [Code Smell](Code Smell), [Unserialization](Unserialization)
