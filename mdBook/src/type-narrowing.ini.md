...
Related : [Smart Cast](Smart Cast), [Type Widening](Type Widening), [instanceof](instanceof), [Type System](Type System), [Type Checking](Type Checking), [Gradual Type Checking](Gradual Type Checking), [Union Type](Union Type), [Static Code Analysis (SCA)](Static Code Analysis (SCA))
