...
Related : [Macro](Macro), [Metaprogramming](Metaprogramming), [Homoiconicity](Homoiconicity), [Eval()](Eval()), [Token](Token), [Code Generation](Code Generation), [Abstract Syntactic Tree (AST)](Abstract Syntactic Tree (AST))
