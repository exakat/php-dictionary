...
Related : [Floating Point Numbers](Floating Point Numbers), [Exponential](Exponential), [Logarithm](Logarithm), [Not A Number (NAN)](Not A Number (NAN)), [INF](INF), [Error Reporting](Error Reporting), [Escape Sequences](Escape Sequences), [Exponent](Exponent)
