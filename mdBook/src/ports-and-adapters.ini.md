...
Related : [Hexagonal Architecture](Hexagonal Architecture), [Adapters](Adapters), [Dependency Injection](Dependency Injection), [Interface](Interface), [Clean Architecture](Clean Architecture), [Layered Architecture](Layered Architecture), [Domain Design Driven (DDD)](Domain Design Driven (DDD))
