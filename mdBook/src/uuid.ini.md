...
Related : [Identifier](Identifier), [Identity](Identity), [Unique Identifier](Unique Identifier), [Correlation ID](Correlation ID), [Idempotent](Idempotent), [Index For SQL](Index For SQL), [Sqids](Sqids), [Universally Unique Lexicographically Sortable Identifier (ULID)](Universally Unique Lexicographically Sortable Identifier (ULID))
