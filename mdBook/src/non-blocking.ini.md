...
Related : [Blocking Wait](Blocking Wait), [Polling](Polling), [Event Loop](Event Loop), [Stream](Stream), [Socket](Socket), [Async](Async), [Edge Triggered](Edge Triggered), [One-shot](One-shot)
