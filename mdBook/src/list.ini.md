...
Related : [Array, []](Array, []), [Comma](Comma), [Double Arrow](Double Arrow), [Square Brackets](Square Brackets), [Tree](Tree), [foreach()](foreach()), [Sequence](Sequence), [Swap](Swap), [Assignment](Assignment), [Multiple Return Values](Multiple Return Values), [Structural Pattern Matching](Structural Pattern Matching), [Tuple](Tuple)
