...
Related : [integer](integer), [Floating Point Numbers](Floating Point Numbers), [PHP_INT_MAX](PHP_INT_MAX), [PHP_INT_MIN](PHP_INT_MIN), [serialize_precision](serialize_precision)
