...
Related : [Generics](Generics), [Compile-time Evaluation](Compile-time Evaluation), [Metaprogramming](Metaprogramming), [Code Generation](Code Generation), [Attribute](Attribute), [Homoiconicity](Homoiconicity), [Const](Const)
