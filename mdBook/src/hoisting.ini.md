...
Related : [Class Hoisting](Class Hoisting), [Class Autoloading](Class Autoloading), [Undefined](Undefined), [Compiler](Compiler), [Cache](Cache), [Order Of Execution](Order Of Execution)
