...
Related : [Event Sourcing](Event Sourcing), [Event Driven](Event Driven), [Message Queue](Message Queue), [Pub/Sub](Pub/Sub), [Event Store](Event Store), [Event Replay](Event Replay)
