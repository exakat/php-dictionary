...
Related : [Const](Const), [Constants](Constants), [Opcache](Opcache), [Just In Time (JIT)](Just In Time (JIT)), [Template Metaprogramming (TMP)](Template Metaprogramming (TMP)), [Metaprogramming](Metaprogramming), [Constant Expression](Constant Expression), [Enumeration (enum)](Enumeration (enum))
