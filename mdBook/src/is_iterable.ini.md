...
Related : [Iterable](Iterable), [Traversable](Traversable), [Iterator](Iterator), [Generator](Generator), [is_array()](is_array()), [is_object()](is_object()), [gettype()](gettype()), [Type Checking](Type Checking)
