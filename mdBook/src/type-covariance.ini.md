...
Related : [Contravariance](Contravariance), [Type Invariant](Type Invariant), [LSP](LSP), [Return Type](Return Type), [Return](Return), [Liskov Substitution Principle (LSP)](Liskov Substitution Principle (LSP))
