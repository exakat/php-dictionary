...
Related : [file://](file://), [File System](File System), [Universal Resource Locator (URL)](Universal Resource Locator (URL)), [Universal Resource Identifier (URI)](Universal Resource Identifier (URI)), [Stream](Stream), [Dir](Dir), [File Extension](File Extension), [Magic Bytes](Magic Bytes), [Path](Path), [zlib extension](zlib extension), [Configuration](Configuration), [Existence](Existence), [fopen()](fopen()), [Permission](Permission), [include](include), [SplFileInfo](SplFileInfo), [SplFileObject](SplFileObject), [EXIF (Exchangeable Image File Format)](EXIF (Exchangeable Image File Format)), [fread()](fread()), [fseek()](fseek()), [ftell()](ftell()), [rewind()](rewind()), [fclose()](fclose()), [fgetc()](fgetc()), [fgets()](fgets()), [fwrite()](fwrite())
