...
Related : [Webserver](Webserver), [Server Application Programming Interface (SAPI)](Server Application Programming Interface (SAPI)), [Command Line Interface (CLI)](Command Line Interface (CLI)), [Readline](Readline)
