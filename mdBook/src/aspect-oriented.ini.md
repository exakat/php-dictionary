...
Related : [Aspect Oriented Programming](Aspect Oriented Programming), [Decorator Pattern](Decorator Pattern), [Middleware Pattern](Middleware Pattern), [Proxy](Proxy), [Paradigm](Paradigm), [Separation Of Concerns](Separation Of Concerns), [Decoupling](Decoupling)
