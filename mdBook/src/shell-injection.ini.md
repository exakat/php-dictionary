...
Related : [Injection](Injection), [escapeshellarg()](escapeshellarg()), [escapeshellcmd()](escapeshellcmd()), [exec](exec), [Shell Exec](Shell Exec), [System](System), [Security](Security), [Taint Analysis](Taint Analysis)
