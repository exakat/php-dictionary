...
Related : [Single Sign On (SSO)](Single Sign On (SSO)), [OpenID Connect (OIDC)](OpenID Connect (OIDC)), [OAuth](OAuth), [Authentication](Authentication), [Lightweight Directory Access Protocol (LDAP)](Lightweight Directory Access Protocol (LDAP)), [Extensible Markup Language (XML)](Extensible Markup Language (XML)), [Token](Token)
