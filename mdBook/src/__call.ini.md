...
Related : [__callStatic() Method](__callStatic() Method), [Magic Methods](Magic Methods), [Method](Method), [Proxy](Proxy), [Meta-object Protocol (MOP)](Meta-object Protocol (MOP)), [Metaclass](Metaclass), [Metaprogramming](Metaprogramming), [Open Class](Open Class)
