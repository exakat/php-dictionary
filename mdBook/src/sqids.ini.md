...
Related : [Universally Unique IDentifier (UUID)](Universally Unique IDentifier (UUID)), [Universally Unique Lexicographically Sortable Identifier (ULID)](Universally Unique Lexicographically Sortable Identifier (ULID)), [Unique Identifier](Unique Identifier), [Identifier](Identifier), [Obfuscation](Obfuscation), [Slug](Slug)
