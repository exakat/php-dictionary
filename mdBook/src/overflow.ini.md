...
Related : [Null](Null), [RangeException](RangeException), [Underflow](Underflow), [OverflowException](OverflowException), [Standard PHP Library (SPL)](Standard PHP Library (SPL)), [Edge Case](Edge Case)
