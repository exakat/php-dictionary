...
Related : :ref:`JavaScript Object Notation (JSON) <json>`, :ref:`Hyper Text Transfer Protocol (HTTP) <http>`, :ref:`Javascript <javascript>`, :ref:`Single Page Application (SPA) <spa>`, :ref:`REST API <rest-api>`, :ref:`Real Time <real-time>`
