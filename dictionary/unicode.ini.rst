...
See also `Unicode Escaping in PHP <https://mojoauth.com/escaping/unicode-escaping-in-php>`_ and `Unicode in PHP <https://unicodefyi.com/guide/unicode-in-php/>`_.
