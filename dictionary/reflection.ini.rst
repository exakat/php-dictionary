...
See also `Introduction to PHP Reflection API <https://medium.com/tech-tajawal/introduction-to-php-reflection-api-4af07cc17db4>`_, `Understanding PHP Reflection: An In-Depth Guide with Examples <https://dev.to/galo4kin/understanding-php-reflection-an-in-depth-guide-with-examples-189n>`_ and `Rewriting reflexion with Rust <https://scherzer.dev/Blog/20260710-reflection-rust>`_.
