...
See also `A Look At PHP’s isset() <https://medium.com/@liamhammett/a-look-at-phps-isset-df64df7158ab>`_ and `__get(), __set(), __isset() and __unset() <https://riptutorial.com/php/example/3635/--get------set------isset---and---unset-->`_.
