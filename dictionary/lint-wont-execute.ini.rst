...
`Documentation <https://www.php.net/manual/en/features.commandline.options.php>`__

Related : :ref:`Source Code <source>`, :ref:`Parse <parse>`, :ref:`Fatal Error <fatal-error>`, :ref:`Syntax Error <syntax-error>`, :ref:`Error <error>`
