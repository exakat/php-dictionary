...
See also `Understand more magic methods: __callStatic() <https://dev.to/ngodinhcuong/understand-more-magic-methods-callstatic-2828>`_ and `PHP __callStatic <https://www.phptutorial.net/php-oop/php-__callstatic/>`_.

Related : :ref:`Magic Methods <magic-method>`, :ref:`__call() Method <-__call>`, :ref:`Visibility <visibility>`
