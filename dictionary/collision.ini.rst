...
`Documentation <https://en.wikipedia.org/wiki/Collision_(computer_science)>`__

Related : :ref:`Namespaces <namespace>`, :ref:`Use In Traits <use-trait>`, :ref:`Use Alias <use-alias>`
