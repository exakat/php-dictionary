...
`Documentation <https://www.php.net/manual/en/funcref.php>`__

See also `The 100 PHP functions in 2022 <https://www.exakat.io/en/the-100-php-functions-in-2022/>`_.

Related : :ref:`Userland <userland>`, :ref:`Dynamic Loading <dynamic-loading>`, :ref:`Foreign Function Interface (FFI) <ffi>`, :ref:`PHP Constants <php-constant>`, :ref:`PHP Variables <php-variable>`
