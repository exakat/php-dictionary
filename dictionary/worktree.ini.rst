...
See also `A practical guide to git worktrees <https://opensource.com/article/21/4/git-worktree>`_.

Related : :ref:`git <git>`, :ref:`Branch <branch>`, :ref:`Version Control System (VCS) <vcs>`, :ref:`Commit <commit>`, :ref:`Timing Attack <timing-attack>`, :ref:`VCS Commit <vcs-commit>`
