...
Related : :ref:`Secure Sockets Layer (SSL) <ssl>`, :ref:`File <file>`, :ref:`Query String <query-string>`, :ref:`Scheme <scheme>`, :ref:`URI Extension <uri-extension>`, :ref:`Universal Resource Identifier (URI) <uri>`, :ref:`Canonical <canonical>`, :ref:`Pound # <pound>`, :ref:`Search Engine Optimization (SEO) <seo>`, :ref:`parse_url() <parse_url>`, :ref:`file_get_contents() <file_get_contents>`, :ref:`fopen() <fopen>`, :ref:`http_build_query() <http_build_query>`, :ref:`URI Class <uri-class>`
