...
See also `SSL context options <https://www.php.net/manual/en/context.ssl.php>`_ and `PHP HTTPS and SSL: Securing Data Transmission <https://codelucky.com/php-https-ssl/>`_.
