...
.. meta::
	:description:
		JSON Lines (JSONC): JSONC, aka SON with Comments, is a superset of JSON that extends its functionality by allowing single-line ``//`` and multi-line ``/* */`` comments.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: JSON Lines (JSONC)
	:twitter:description: JSON Lines (JSONC): JSONC, aka SON with Comments, is a superset of JSON that extends its functionality by allowing single-line ``//`` and multi-line ``/* */`` comments
	:twitter:creator: @exakat
	:twitter:image:src: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:title: JSON Lines (JSONC)
	:og:type: article
	:og:description: JSONC, aka SON with Comments, is a superset of JSON that extends its functionality by allowing single-line ``//`` and multi-line ``/* */`` comments
	:og:url: https://php-dictionary.readthedocs.io/en/latest/dictionary/jsonc.ini.html
	:og:locale: en
.. raw:: html

	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/jsonc.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/jsonc.ini.html","name":"JSON Lines (JSONC)","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Thu, 23 Jul 2026 13:40:38 +0000","dateModified":"Thu, 23 Jul 2026 13:40:38 +0000","description":"JSONC, aka SON with Comments, is a superset of JSON that extends its functionality by allowing single-line ``\/\/`` and multi-line ``\/* *\/`` comments","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/JSON Lines (JSONC).html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
Related : :ref:`json_decode() <json_decode>`, :ref:`JSON Lines (JSONL) <jsonl>`, :ref:`JavaScript Object Notation (JSON) <json>`, :ref:`json_encode() <json_encode>`, :ref:`Parquet <parquet>`
