...
See also `PHP 8.0 feature focus: Weak maps <https://platform.sh/blog/php-80-feature-focus-weak-maps/>`_ and `WeakReferences <https://www.cmuir.co.nz/post/weakreferences/>`_.

Related : :ref:`References <reference>`, :ref:`Circular Reference <circular-reference>`
