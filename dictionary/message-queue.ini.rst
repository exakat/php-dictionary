...
.. raw:: html
	...
	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/message-queue.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/message-queue.ini.html","name":"Message Queue","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Tue, 30 Jun 2026 15:15:22 +0000","dateModified":"Tue, 30 Jun 2026 15:15:22 +0000","description":"A message queue server is a middleware component or service that facilitates communication between different software components or systems by enabling asynchronous message passing","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/Message Queue.html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
`Documentation <https://en.wikipedia.org/wiki/Message_queue>`__

See also `Best Lightweight PHP Message Queue <https://blog.iron.io/best-lightweight-php-message-queue/>`_.

Related : :ref:`Jobqueue <jobqueue>`, :ref:`Message Bus <message-bus>`, :ref:`Pub/Sub <pubsub>`, :ref:`Queue <queue>`, :ref:`Serialization <serialization>`, :ref:`Change Data Capture <change-data-capture>`, :ref:`Distributed Systems <distributed-systems>`, :ref:`Event Streaming <event-streaming>`, :ref:`Fire-and-forget <fire-and-forget>`, :ref:`Internet of Things (IoT) <iot>`
