...
.. raw:: html
	...
	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/json_decode.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/json_decode.ini.html","name":"json_decode()","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Mon, 15 Jun 2026 11:03:59 +0000","dateModified":"Mon, 15 Jun 2026 11:03:59 +0000","description":"``json_decode()`` decodes a JSON string into a data structure","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/json_decode().html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
Related : :ref:`JavaScript Object Notation (JSON) <json>`, :ref:`json_encode() <json_encode>`, :ref:`Null <null>`, :ref:`Strpos() Syndrome <strpos-syndrom>`, :ref:`ValueError <valueerror>`, :ref:`JSON Lines (JSONC) <jsonc>`, :ref:`JSON Lines (JSONL) <jsonl>`, :ref:`Parquet <parquet>`
