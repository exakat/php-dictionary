...
Related : :ref:`Cross Site Request Forgery (CSRF) <csrf>`, :ref:`html_entity_decode <html_entity_decode>`, :ref:`htmlspecialchars <htmlspecialchars>`, :ref:`Static Application Security Testing (SAST) <sast>`, :ref:`Session Hijacking <session-highjacking>`, :ref:`Vulnerability <vulnerability>`, :ref:`Anchor <anchor>`, :ref:`CSS <css>`, :ref:`Escape Character <escape-character>`, :ref:`Link <link>`, :ref:`HTML Entity <html-entity>`, :ref:`CRLF Injection <crlf-injection>`, :ref:`Data Flow Analysis (DFA) <data-flow-analysis>`, :ref:`Image Injection <image-injection>`, :ref:`Twig <twig>`
