...
.. meta::
	:description:
		Blackfire: Blackfire is a PHP profiler and performance testing platform.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: Blackfire
	:twitter:description: Blackfire: Blackfire is a PHP profiler and performance testing platform
	:twitter:creator: @exakat
	:twitter:image:src: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:title: Blackfire
	:og:type: article
	:og:description: Blackfire is a PHP profiler and performance testing platform
	:og:url: https://php-dictionary.readthedocs.io/en/latest/dictionary/blackfire.ini.html
	:og:locale: en
.. raw:: html
