...
`Documentation <https://en.wikipedia.org/wiki/Synchronous_programming_language>`__
...
Related : :ref:`Asynchronous <asynchronous>`, :ref:`Blocking Wait <blocking-wait>`
