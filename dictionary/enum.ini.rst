...
Related : :ref:`Enumeration Case <enum-case>`, :ref:`Collection <collection>`, :ref:`Class Interface Trait Enumeration (CITE) <cite>`, :ref:`Backed Enum <backed-enum>`, :ref:`BackedEnum <backedenum>`, :ref:`Case <case>`, :ref:`http_build_query() <http_build_query>`, :ref:`Unbacked Enum <unbacked-enum>`, :ref:`UnitEnum <unitenum>`, :ref:`Dynamic Class Constant <dynamic-class-constant>`
