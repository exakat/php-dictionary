...
See also `Stub Files - PHPStan User Guide <https://phpstan.org/user-guide/stub-files>`_.

Related : :ref:`compact() <compact>`

Related packages : `php-stubs/generator <https://packagist.org/packages/php-stubs/generator>`_
