...
See also `The little singleton <https://blog.cleancoder.com/uncle-bob/2015/07/01/TheLittleSingleton.html>`_, `Stop Using Singleton Pattern <https://medium.com/@dotcom.software/stop-using-singleton-pattern-c078abc99eb2>`_, `PHP Design Patterns Game : The Singleton Pattern <https://phpmagazine.net/2023/03/php-design-patterns-game-the-singleton-pattern.html>`_ and `The Singleton Labyrinth <https://dev.to/suckup_de/the-singleton-labyrinth-19je>`_.

Related : :ref:`Design Pattern <design-pattern>`, :ref:`Multiton <multiton>`
