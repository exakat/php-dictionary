...
See also `LDAP Injection Prevention Cheat Sheet — OWASP <https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html>`_ and `ldap_escape() — PHP Manual <https://www.php.net/manual/en/function.ldap-escape.php>`_.
