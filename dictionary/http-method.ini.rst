...
Related : :ref:`Hyper Text Transfer Protocol (HTTP) <http>`, :ref:`REST API <rest-api>`, :ref:`Idempotent <idempotent>`, :ref:`HTTP Headers <http-header>`, , :ref:`Response <response>`
