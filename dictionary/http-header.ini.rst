...
Related : :ref:`Hyper Text Transfer Protocol (HTTP) <http>`, :ref:`Hyper Text Transfer Protocol Secure (HTTPS) <https>`, :ref:`PHP Handlers <handler>`, :ref:`Headers <headers>`, :ref:`HTTP Request Headers <http-headers>`
