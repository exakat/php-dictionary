...
Related : :ref:`Hyper Text Transfer Protocol (HTTP) <http>`, :ref:`HTTP Headers <http-header>`, :ref:`JavaScript Object Notation (JSON) <json>`, :ref:`Webhook <webhook>`, :ref:`JSON Web Token (JWT) <jwt>`, :ref:`Response <response>`, :ref:`php://input <php-input>`, :ref:`Request <request>`
