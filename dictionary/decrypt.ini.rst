...
.. meta::
	:description:
		To Decrypt: To decrypt is to apply a data transformation on encrypted data to access the original and readable information.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: To Decrypt
	:twitter:description: To Decrypt: To decrypt is to apply a data transformation on encrypted data to access the original and readable information
	:twitter:creator: @exakat
	:twitter:image:src: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:title: To Decrypt
	:og:type: article
	:og:description: To decrypt is to apply a data transformation on encrypted data to access the original and readable information
	:og:url: https://php-dictionary.readthedocs.io/en/latest/dictionary/decrypt.ini.html
	:og:locale: en
.. raw:: html

	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/decrypt.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/decrypt.ini.html","name":"To Decrypt","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Fri, 19 Jun 2026 21:24:03 +0000","dateModified":"Fri, 19 Jun 2026 21:24:03 +0000","description":"To decrypt is to apply a data transformation on encrypted data to access the original and readable information","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/To Decrypt.html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
Related : :ref:`Asymmetric Cryptography <asymmetric-cryptography>`, :ref:`To Crypt <crypt>`, :ref:`Crack <crack>`, :ref:`Convert <convert>`
