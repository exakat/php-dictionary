...
`Documentation <https://en.wikipedia.org/wiki/Inheritance_(object-oriented_programming)>`__

See also `Exploring Inheritance in PHP <https://linu.us/exploring-inheritance-in-php>`_ and `Clean code with PHP namespaces <https://www.honeybadger.io/blog/php-namespaces/>`_.
