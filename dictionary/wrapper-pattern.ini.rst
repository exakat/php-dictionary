...
.. meta::
	:description:
		Wrapper Pattern: The wrapper pattern is also called decorator or adapter.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: Wrapper Pattern
	:twitter:description: Wrapper Pattern: The wrapper pattern is also called decorator or adapter
	:twitter:creator: @exakat
	:twitter:image:src: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-dictionary.readthedocs.io/en/latest/_static/logo.png
	:og:title: Wrapper Pattern
	:og:type: article
	:og:description: The wrapper pattern is also called decorator or adapter
	:og:url: https://php-dictionary.readthedocs.io/en/latest/dictionary/wrapper-pattern.ini.html
	:og:locale: en
.. raw:: html

	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/wrapper-pattern.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/wrapper-pattern.ini.html","name":"Wrapper Pattern","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Mon, 15 Jun 2026 11:03:59 +0000","dateModified":"Mon, 15 Jun 2026 11:03:59 +0000","description":"The wrapper pattern is also called decorator or adapter","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/Wrapper Pattern.html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
Related : :ref:`PHP Wrappers <php-wrapper>`, :ref:`file:// <wrapper-file>`, :ref:`Thin Method <thin-method>`, :ref:`Application Programming Interface (API) <api>`, :ref:`Wrapper <wrapper>`
