...
Related : :ref:`Dataset <dataset>`, :ref:`Vector Database <vector-database>`, :ref:`SQL Database <sql-database>`, :ref:`Nosql Database <nosql-database>`, :ref:`Key-value Stores <key-value-store>`, :ref:`XML Database <xml-database>`, :ref:`Connexion Persistence <connexion-persistence>`, :ref:`Database Abstraction Layer (DBA) Extension <dba>`, :ref:`Framework <framework>`, :ref:`Schema <schema>`, :ref:`Application Server <app-server>`, :ref:`Permission <permission>`, :ref:`PostgreSQL <pgsql>`, :ref:`Rollback <rollback>`, :ref:`Search Engine <search-engine>`
