...
`Documentation <https://en.wikipedia.org/wiki/Implicit_type_conversion>`__

Related : :ref:`Explicit <explicit>`, :ref:`Appeasement Pattern <appeasement-pattern>`, :ref:`Distributed State <distributed-state>`, :ref:`Hidden State <hidden-state>`, :ref:`Implicit State <implicit-state>`
