...
See also `Kind (type theory) on Wikipedia <https://en.wikipedia.org/wiki/Kind_(type_theory)>`_ and `marcosh/lamphpda <https://github.com/marcosh/lamphpda>`_.
