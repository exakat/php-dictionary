...
See also `The PHP Foundation's mission to keep millions of sites safe <https://opensourcepledge.com/blog/the-php-foundation/>`_ and `The Quiet Shift Reshaping PHP Security <https://www.linkedin.com/pulse/quiet-shift-reshaping-php-security-matthew-weier-o-phinney-fgquc/>`_.

Related : :ref:`PHP Group <php-group>`, :ref:`PHP RFC <php-rfc>`
