...
.. raw:: html
	...
	<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"DefinedTerm","@id":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/domain-name.ini.html","url":"https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/domain-name.ini.html","name":"Domain Name","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Fri, 10 Jul 2026 09:41:47 +0000","dateModified":"Fri, 10 Jul 2026 09:41:47 +0000","description":"A domain name is a human-readable label that identifies a network resource, such as a web server","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-dictionary.readthedocs.io\/en\/latest\/dictionary\/Domain Name.html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
...
See also `Domain Name System <https://en.wikipedia.org/wiki/Domain_Name_System>`_.

Related : :ref:`Universal Resource Locator (URL) <url>`, :ref:`Domain Name System (DNS) <dns>`, :ref:`Hyper Text Transfer Protocol (HTTP) <http>`, :ref:`parse_url() <parse_url>`, :ref:`Domain <domain>`, :ref:`SplSubject <splsubject>`
