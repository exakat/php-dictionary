...
See also `PHPStan <https://phpstan.org/>`_, `Psalm <https://psalm.dev/>`_, `Exakat <https://www.exakat.io/>`_, `Mago <https://mago.carthage.software/1.45.0/en/>`_ and `Top 7 Methods, Pros/Cons and Best Practices <https://www.oligo.security/academy/static-code-analysis>`_.
