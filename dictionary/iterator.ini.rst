...
See also `Modern PHP Developer - Iterator <https://startutorial.com/view/modern-php-developer-iterator>`_ and `Iterator in PHP <https://refactoring.guru/design-patterns/iterator/php/example>`_.

Related : :ref:`Standard PHP Library (SPL) <spl>`, :ref:`Traversal <traversal>`, :ref:`foreach() <foreach>`, :ref:`ArrayObject <arrayobject>`, :ref:`DirectoryIterator <directoryiterator>`, :ref:`iterator_to_array() <iterator_to_array>`, :ref:`PHP Native Interfaces <php-interface>`, :ref:`RecursiveIterator <recursiveiterator>`, :ref:`IteratorAggregate <iteratoraggregate>`, :ref:`OuterIterator <outeriterator>`, :ref:`RecursiveArrayIterator <recursivearrayiterator>`, :ref:`RecursiveDirectoryIterator <recursivedirectoryiterator>`, :ref:`SeekableIterator <seekableiterator>`, :ref:`SplDoublyLinkedList <spldoublylinkedlist>`, :ref:`SplFileObject <splfileobject>`, :ref:`SplObjectStorage <splobjectstorage>`
