...
`Documentation <https://en.wikipedia.org/wiki/Byte>`__

Related : :ref:`Character <character>`, :ref:`Multi-byte <multi-byte>`, :ref:`American Standard Code for Information Interchange (ASCII) <ascii>`
